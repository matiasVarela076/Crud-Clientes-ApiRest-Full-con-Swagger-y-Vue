        ...
        <form @submit.prevent="handleSubmit" class="modal-body">
          <div class="form-row">
            <div class="form-group">
              ...
              <input v-model="formData.nombres" type="text" required placeholder="Juan" />
            </div>
            <div class="form-group">
              <label>Apellidos <span class="required">*</span></label>
              <input v-model="formData.apellidos" type="text" required placeholder="Pérez" />
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input v-model="formData.telefonoCelular" type="text" required placeholder="1123456789" />
            </div>
          </div>
...
watch(() => props.cliente, (newVal) => {
  if (newVal) {
    formData.value = {
      ...
      nombres: newVal.NOMBRE || newVal.nombre || '',
      apellidos: newVal.APELLIDO || newVal.apellido || '',
      cuit: newVal.CUIT || newVal.cuit || '',
      telefonoCelular: newVal.TELEFONO || newVal.telefono || '',
...
function handleSubmit() {
  // Mapear campos del formulario al formato de la API (mayúsculas)
  const apiData = {
    ID: formData.value.id || 0,
    NOMBRE: formData.value.nombres,
    APELLIDO: formData.value.apellidos,
    CUIT: formData.value.cuit,
    TELEFONO: formData.value.telefonoCelular,
